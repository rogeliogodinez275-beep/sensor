...
from sensorfact.logprob_reranker import (
    run_choice_logprob_reranker,
    run_logprob_reranker,
    run_position_prior_logprob_reranker,
)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--mode", choices=["yesno", "choice", "position-prior"], default="yesno")
...
def main() -> None:
    ...
    if args.mode == "choice":
        runner = run_choice_logprob_reranker
    elif args.mode == "position-prior":
        runner = run_position_prior_logprob_reranker
    else:
        runner = run_logprob_reranker
    metrics = runner(
